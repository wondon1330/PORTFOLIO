...
<b>솔트</b>(단방향 함수의 추가 입력으로 사용되는 랜덤 데이터)를 <b>추가</b>함으로 끝내 제가 <b>원하던 결과</b>를 얻을 수 있었습니다.
입력한 <b>패스워드 원문</b>에 임의의 문자값인 솔트 값을 이어 덧붙여서 해시처리를 하게됩니다. 이렇게 하게 되면 <b>같은 패스워드</b>를 입력하더라도 <b>DB</b>에는 값이 <b>서로 다르게 저장</b> 및 <b>조회</b>되게 됩니다.
<br>
<br>
