...
입력한 패스워드 원문에 임의의 문자값인 솔트 값을 이어 덧붙여서 해시처리를 하게됩니다. 이렇게 하게 되면 <b>같은 패스워드를 입력</b>하더라도 DB에는 값이 <b>서로 다르게 저장 및 조회</b>가 가능하게 됩니다.
<br>
<br>
...
복구 이메일 주소로 발송 받은 임시 비밀번호로 로그인이 가능합니다.
<hr>
