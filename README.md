...
저의 전공인 영어학을 활용해 프로그래밍 관련 용어의 직접적인 의미를 보다 빠르게 습득할 수 있습니다. 새로운 지식이나 예약어등이 나와도 어떠한 기능을 하는지 손쉽게 유추할 수 있습니다. 
새로운 경험을 받아들이는 것에 거부감이 없습니다. 아우러 사람들과 소통하고자 하는 의지가 강합니다. 다양한 경험을 통해 한걸음 더 넓게 나아가고 싶습니다.
<br>
